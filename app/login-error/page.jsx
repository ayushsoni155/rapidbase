...
export default function AuthErrorPage() {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center justify-center text-center px-6 overflow-hidden">
      ...
      {/* Error Title */}
      <h1 className="text-6xl font-extrabold bg-gradient-to-r from-red-500 via-orange-400 to-yellow-400 bg-clip-text text-transparent drop-shadow-[0_0_20px_rgba(255,99,71,0.6)] animate-pulse">
