...
const DATA_TYPES = [
  ...
  { value: "TIMESTAMP WITH TIME ZONE", description: "Date and time with timezone." },
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent className="max-w-sm space-y-1">
                          {Object.values(CONSTRAINTS).map(({ label, description }) => (
                            <p key={label}>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleColumnChange(index, "referencesTable", e.target.value)
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleColumnChange(index, "referencesColumn", e.target.value)
                        }
                        placeholder="e.g., id"
                        className="w-full"
                      />
