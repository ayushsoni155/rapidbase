...
// The component now accepts `open` and `onOpenChange` props
export default function LoginPopup({ open, onOpenChange }) {
  const handleSignIn = (provider) => {
    signIn(provider);
    onOpenChange(false); // Close the dialog after initiating sign-in
  };

  return (
    // The Dialog is now controlled by the props passed from its parent
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* The DialogTrigger is removed from this component */}
